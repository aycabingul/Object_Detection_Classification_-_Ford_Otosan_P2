...
-  [ **Semantic Segmentation**](#anabaslik1)
    ...
    -  [What is Deep Learning?](#paragraph3)
   - [What is Neural Network (NN)?](#paragraph4)
   -  [What is Convolution Neural Network (CNN)?](#paragraph5)
   -  [What is segmentation task in NN?](#paragraph6)
       -  [Semantic segmentation](#subparagraph3)
       -  [Instance segmentation](#subparagraph4)
    -  [What is classification task in NN?](#paragraph7)
    -  [Compare segmentation and classification in NN](#paragraph8)
    -  [ What is data and dataset difference?](#paragraph9)
    -  [ What is the difference between supervised and unsupervised learning in terms of dataset?](#paragraph10)
    -  [ *Data Preprocessing*](#paragraph11)
          -  [ Extracting Masks](#paragraph12)
              - [What is color space ?](#paragraph13)
              - [What RGB stands for ?](#paragraph14)
              -  [ In Python, can we transform from one color space to another?](#paragraph15)
              -  [What is the popular library for image processing?](#paragraph16)
        -  [Converting into Tensor](#paragraph17)
           -  [What is Computational Graph?](#paragraph18)
           - [What is Tensor?](#paragraph19)
           -  [What is one hot encoding?](#paragraph20)
           -  [What is CUDA programming?](#paragraph21)
    -  [*Design Segmentation Model*](#paragraph22)
         -  [What is the difference between CNN and Fully CNN (FCNN) ?](#paragraph23)
        -  [What are the different layers on CNN ?](#paragraph24)
            - [Convolutional Layer](#paragraph25)
             - [Pooling Layer](#paragraph26)
              -  [Fully Connected Layer](#paragraph27)
       -   [What is activation function ?](#paragraph28)
      -  [*Train*](#paragraph29)
            -  [What is parameter and hyper-parameter in NN ?](#paragraph30)
            -  [Validation Dataset](#paragraph31)
            -   [What is an epoch?](#paragraph32)
            -  [What is batch?](#paragraph33)
            -  [What is iteration?](#paragraph34)
            -  [What Is the Cost Function?](#paragraph35)
            -  [What is/are the purpose(s) of an optimizer in NN?](#paragraph36)
            -  [What is Batch Gradient Descent & Stochastic Gradient Descent?](#paragraph37)
            -  [What is Backpropogation ? What is used for ?](#paragraph38)
