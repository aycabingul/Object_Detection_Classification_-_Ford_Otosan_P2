...
class LINE_NET(nn.Module):#A class named FoInternNet was created
    def __init__(self,input_size,n_classes):
        ...
        self.dconv_up5 = double_conv(512 + 1024, 512)
    ...
    def forward(self, x):
        ...
        #print("upsample")
        #print(x.shape)
        x = torch.cat([x, conv5], dim=1)#Combines the given tensor array at the given size 
